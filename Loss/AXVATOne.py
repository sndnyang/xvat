...
class AXVATOne(object):
    ...
    def __call__(self, model, images, generator, l0_ins, kl_way=1):
        ...
        perturbations = 2 * images * train_mask
        ...
        lds += compute_lds(model, images.detach(), self.dis_criterion, prob_x, log_prob_x, kl_way=kl_way)
        if self.args.alpha > 0.01:
